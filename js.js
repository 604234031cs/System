...
for(dayn = 1;dayn<=b;dayn++){
    ...
    if(txtnm=='อาทิต'){txtdayw += "<td style='background-color:red!important;color:#fff!important;font-size:11px!important'>"+txtnm+"</td>";}
    else if(datecur==txtc){txtdayw += "<td style='background-color:blue!important;color:#fff!important;font-size:11px!important'>"+txtnm+"</td>";}
    else{txtdayw += "<td style='font-size:11px!important'><b>"+txtnm+"</b></td>";}   
